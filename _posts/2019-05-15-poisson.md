...
We actually get an even stronger result, in that the $A_i$'s don't even have to be independent! Namely, an analogous result still holds if the variables are "locally dependent"; see e.g. [this paper](https://projecteuclid.org/download/pdfview_1/euclid.ps/1319806862){: target="_blank"}.
