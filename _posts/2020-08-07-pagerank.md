...
If you're working with a graph database in [Neo4j](https://neo4j.com/) then you can run PageRank directly in your Cypher query. You have to [create a graph in the graph catalog](https://neo4j.com/docs/graph-data-science/current/management-ops/graph-catalog-ops/#catalog-graph-create), and then call the following:
